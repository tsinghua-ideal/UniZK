...
class GenericDRAMSystem final : public IMemorySystem, public Implementation {
  ...
  public:
    ...
    int get_s_num_read_requests() {
      return s_num_read_requests;
    }

    int get_s_num_write_requests() {
      return s_num_write_requests;
    }

    int get_s_num_other_requests() {
      return s_num_other_requests;
    }
